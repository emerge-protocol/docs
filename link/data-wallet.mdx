...
- Delete their account from **Settings** (permanent)
...
![Data Wallet account deletion in Settings](/images/data-wallet-delete-account.png)

## Delete your account (Settings)

Account deletion lives in the **Settings** page. If a user deletes their account, it permanently removes their Data Wallet profile, revokes partner data sharing permissions, and deletes stored personal data. You should treat this as irreversible in your app and support flows.
