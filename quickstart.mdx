...
<Tabs>
  <Tab title="Cursor">
    ...
    {
      "mcpServers": {
        "Emerge": { "url": "https://emerge.mintlify.dev/mcp" }
      }
    }
    ```
  </Tab>
  ...
  <Tab title="VS Code">
    ...
    {
      "servers": {
        "Emerge": { "type": "http", "url": "https://emerge.mintlify.dev/mcp" }
      }
    }
    ```
  </Tab>
...
## Step 5: Connect AI tools (optional)
...
Or see [AI Integration](/ai/overview) for more options.
