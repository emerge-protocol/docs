...
<Note>
**Looking for the Query API MCP server?** This page covers the **documentation MCP server**. For AI agent access to the Query API (data retrieval), see [MCP Server for Query API](/ai/mcp-server).
</Note>
...
| **Query API** | Retrieve user data | `https://mcp.emergedata.ai` |

This page covers the **Documentation MCP server** setup. For Query API MCP server setup, see [MCP Server for Query API](/ai/mcp-server).
