...
<CardGroup cols={2}>
  <Card title="Claude Code" icon="code" href="/ai/mcp-setup">
    Command-line AI agent
  </Card>
  <Card title="Claude Desktop" icon="desktop" href="/ai/mcp-setup">
    Desktop application
  </Card>
  <Card title="Cursor" icon="cursor" href="/ai/mcp-setup">
    AI-powered code editor
  </Card>
  <Card title="VS Code" icon="code" href="/ai/mcp-setup">
